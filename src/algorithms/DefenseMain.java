...
public class DefenseMain extends Brain {
    ...
    public DefenseMain() { super(); gen = new Random(); }
    ...
    public void step() {
      ...
      turnTask=false;
          if (taskOne) endTaskCounter=600; else if (id==1) endTaskCounter=300; else endTaskCounter=200;
      move();
        } else {
          if (taskOne) stepTurn(Parameters.Direction.LEFT);
