...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAName = "Pokemon Team";
  public static final String teamAMainBotBrainClassName = "algorithms.Stage1SecondaryA"; //class given by name; is supposed to extends robotsimulator.Brain
  public static final String teamAMainBotAvatar = "avatars/pikachu.png"; //path relative to location of ant build.xml file
  ...
  public static final String teamASecondaryBotAvatar = "avatars/pokemon.png"; //path relative to location of ant build.xml file
  ...
  //---TEAM-B-PARAMETERS---//
  //-----------------------//
  public static final String teamBName = "Team Rocket";
  ...
  public static final String teamBMainBotAvatar = "avatars/rocket.png"; //path relative to location of ant build.xml file
  ...
  public static final String teamBSecondaryBotAvatar = "avatars/rocket.png"; //path relative to location of ant build.xml file
